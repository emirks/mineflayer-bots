...
const LOOP_OPTIONS = {
    // ── Item ─────────────────────────────────────────────────────────────────
    itemName: 'observer',
    searchTerm: 'observer',    // /ah <searchTerm> — match DonutSMP AH browse if needed
    orderCommand: '/order',

    // ── Price ─────────────────────────────────────────────────────────────────
    decrementAmount: 10,                // $ to undercut the lowest listing by
    minPriceFloor: 1500,              // never list below this $ per torch (tune to market)
...
module.exports = {
    ...
    bot: {
        ...base.bot,
        username: 'tommycarver8@gmail.com',
