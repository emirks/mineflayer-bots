...
const { auctionSellAll, parseMoneyString: auctionParseMoneyString,
        formatMoney: auctionFormatMoney }             = require('./auctionSell')
...
const { chatComponentToText, normalizeText, getDisplayName, getLore,
        findSlotByKeyword, summariseSlot }            = require('./nbtParse')
