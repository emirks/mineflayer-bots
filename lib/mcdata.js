...
const prismarine_items = require('prismarine-item');
 ...
 */
function getDetailedCraftingPlan(targetItem, count = 1, current_inventory = {}) {
...
module.exports = { init, WOOD_TYPES, MATCHING_WOOD_BLOCKS, WOOL_COLORS, isHuntable, isHostile, mustCollectManually, getItemId, getItemName, getBlockId, getBlockName, getEntityId, getAllItems, getAllItemIds, getAllBlocks, getAllBlockIds, getAllBiomes, getItemCraftingRecipes, isSmeltable, getSmeltingFuel, getFuelSmeltOutput, getItemSmeltingIngredient, getItemBlockSources, getItemAnimalSource, getBlockTool, makeItem, ingredientsFromPrismarineRecipe, calculateLimitingResource, initializeLoopingItems, getDetailedCraftingPlan }
