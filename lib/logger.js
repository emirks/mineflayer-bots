...
const A = {
  ...
  warn: '\x1b[33m',   // yellow
  error: '\x1b[31m',   // red
  perf: '\x1b[96m',   // bright cyan — timing / profiling lines
...
const LEVEL_LABEL  = { debug: 'DEBUG', info: 'INFO ', warn: 'WARN ', error: 'ERROR', perf: 'PERF ' }
const LEVEL_COLOUR = { debug: A.debug, info: A.info, warn: A.warn, error: A.error, perf: A.perf }
